<?php
// Utility function to establish a secure connection to SQLite
function get_db_connection() {
    // SQLite database configuration
    try {
        $db = new PDO('sqlite:projects.db'); // Path to the SQLite database
...
// Utility function to validate user inputs
